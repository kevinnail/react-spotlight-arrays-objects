...
// export const printUserInfo =({  // CHECK SCREENSHOTS
//   username,
//   name:{first, last},
//   info:{
//     favorites...
...
export const getFirstTwoArgs = (a, b, ...rest) => {
  // return [a, b, [...rest]]
  return [a, b, rest] // actual answer but ^^ works... rest is an array here
}
...
// CHECK SCREENSHOTS (shoes is actually shoeList I think...)
// ALSO THERE IS A 2ND WAY TO DO IT
...
export const totalSneakerCount = (brands) => {
  ...
  for (let brand in brands) {
    total += brands[brand].shoes.length
  }
  return total
  // CHECK SCREENSHOTS
}
